...
// v0.3.19（三席联审 A2）：组局/邀约 DM 的场所白名单——生成器上下文里没有世界书条目
//（只拼声音卡），不喂名单它就会编造不存在的场子，玩法单的场所 keys 永远等不来命中。
var PT_VENUES =
  '【场子白名单·铁律】S市能约的场子只有这些，邀约/组局只许用它们，绝不发明别的场子名：\n' +
  '- 云顶会（KTV，最常去的主场）\n' +
  '- 金茂88层·行政酒廊（下午茶搭线、出台）\n' +
  '- 外滩18号·酒窖（老俞的柜台，存酒/盲品，生面孔要引荐人领）\n' +
  '- 云汀俱乐部（要门票，雷万钧才能带）\n' +
  '- 静安府邸（私房菜馆，家宴局）\n' +
  '拿不准对方知不知道某个场子，就只说「老地方」。\n\n';
